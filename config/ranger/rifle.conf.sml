...
!mime ^text, label editor, ext xml|json|csv|tex|py|pl|rb|js|sh|php|md|sml|vim = ${VISUAL:-$EDITOR} -- "$@"
!mime ^text, label pager,  ext xml|json|csv|tex|py|pl|rb|js|sh|php|md|sml|vim = "$PAGER" -- "$@"
