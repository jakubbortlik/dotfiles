...
!mime ^text, label editor, ext xml|json|csv|tex|py|pl|rb|js|sh|php|md|symlink|vim = $EDITOR -- "$@"
!mime ^text, label pager,  ext xml|json|csv|tex|py|pl|rb|js|sh|php|md|symlink|vim = "$PAGER" -- "$@"
